...
impl Item {
    pub fn materials(self) -> HashMap<Material, usize> {
        match self {
            Item::Bulkhead => HashMap::from([
                (Material::Titanium, 3),
                (Material::SiliconeRubber, 1),
            ]),
            Item::Foundation => HashMap::from([
                (Material::Lead, 2),
                (Material::Titanium, 2),
            ]),
            Item::GlassCompartment => HashMap::from([
                (Material::Glass, 2)
            ]),
            Item::TitaniumCompartment => HashMap::from([
                (Material::Titanium, 2)
            ]),
            Item::Hatch => HashMap::from([
                (Material::Titanium, 2),
                (Material::Quartz, 1),
            ]),
            ...
            Item::Observatory => HashMap::from([
                (Material::EnamledGlass, 2),
                (Material::Titanium, 1),
            ]),
            Item::Reinforcement => HashMap::from([
                (Material::Titanium, 3),
                (Material::Lithium, 1),
            ]),
            ...
            Item::VerticalConnector => HashMap::from(
                [(Material::Titanium, 2)
            ]),
            ...
            Item::Window => HashMap::from([
                (Material::Glass, 2),
            ]),
            Item::MultipurposeRoom => HashMap::from([
                (Material::Titanium, 6),
            ]),
            ...
            Item::LargeRoom => HashMap::from([
                (Material::PlasteelIngot, 2),
            ]),
